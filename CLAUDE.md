...
**Update Gemini:** `_scripts/deprecated/updatesmallweb.sh -t gemini` (until manage.py gemini ready)
...
_scripts/deprecated/updatesmallweb.sh -t gemini  # Update Gemini (until manage.py gemini ready)
```
