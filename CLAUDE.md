...
**Generate Gemini (Tailscale):** Docker container configured for jezebel hostname, no regeneration needed
...
See `_scripts/README.md`, `tests/README.md`, and `GEMINI_DEPLOY.md` for detailed documentation.
